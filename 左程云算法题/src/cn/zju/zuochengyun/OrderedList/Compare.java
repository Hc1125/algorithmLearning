package cn.zju.zuochengyun.OrderedList;
...
public class Compare {
	...
	public static void functionTest() {
		...
		code1_AVLTreeMap.AVLTreeMap<Integer, Integer> avl = new code1_AVLTreeMap.AVLTreeMap<>();
		code2_SizeBalancedTreeMap.SizeBalancedTreeMap<Integer, Integer> sbt = new code2_SizeBalancedTreeMap.SizeBalancedTreeMap<>();
		code3_SkipListMap.SkipListMap<Integer, Integer> skip = new code3_SkipListMap.SkipListMap<>();
		int maxK = 500;
		int maxV = 50000;
	...
	public static void performanceTest() {
		...
		code1_AVLTreeMap.AVLTreeMap<Integer, Integer> avl;
		code2_SizeBalancedTreeMap.SizeBalancedTreeMap<Integer, Integer> sbt;
		code3_SkipListMap.SkipListMap<Integer, Integer> skip;
		long start;
		long end;
		int max = 100000;
		treeMap = new TreeMap<>();
		avl = new code1_AVLTreeMap.AVLTreeMap<>();
		sbt = new code2_SizeBalancedTreeMap.SizeBalancedTreeMap<>();
		skip = new code3_SkipListMap.SkipListMap<>();
