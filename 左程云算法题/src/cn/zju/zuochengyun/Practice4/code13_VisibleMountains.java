 ...
 * 山峰A和山峰B能够相互看见的条件为: 1.如果A和B是同一座山，认为不能相互看见。
 ...
 */
public class code13_VisibleMountains {
    // 如果环形山没有重复数字，必是2 * N - 3对可见山峰
    public int getVisibleMountainsNoRepeat(int[] nums) {
        return 2 * nums.length - 3;
    }
