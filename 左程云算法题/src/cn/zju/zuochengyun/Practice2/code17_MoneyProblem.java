 ...
 * 然后怪兽就会加入你，他的能力直接累加到你的能力上；如果你当前的能力，大于等于
 * i号怪兽的能力，你可以选择直接通过，你的能力并不会下降，你也可以选择贿赂这个怪兽
 * 然后怪兽就会加入你，他的能力直接累加到你的能力上。
 * 返回通过所以的怪兽，需要花的最小钱数。
 */
public class code17_MoneyProblem {
    /**
     *
     * @param d  i号怪兽的能力
     * @param p  i号怪兽要求的钱
     ...
     * @return
     * 目前你的能力是hp，你来到了index号怪兽的面前，如果要通过后续所以的怪兽
     * 请返回需要花的最少钱数
     */
    ...
    // dp[i][j] 代表面对第i号怪兽,能力为j时,所需要的最小money
    // 适用于怪兽能力和不大的情况下
    ...
    public static long dp2(int[] d, int[] p) {
        ...
        /**
         * dp[i][j]含义：
         * 能经过0~i的怪兽，且花钱为j（花钱严格等于j）时的武力最大值是多少？
        ...
        // 经过0~i的怪兽，花钱数一定为p[0]，达到武力值d[0]的的地步。其他第0行的状态一律是无效的
        dp[0][p[0]] = d[0];
         ...
         * 能经过0~N-1的怪兽，且花钱为j（严格等于j）时的武力最大值是多少？
