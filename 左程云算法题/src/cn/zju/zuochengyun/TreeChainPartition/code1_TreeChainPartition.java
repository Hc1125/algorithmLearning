package cn.zju.zuochengyun.TreeChainPartition;

import java.util.HashMap;

/**
 * 给定数组father，大小为N,表示一共有N个节点
 * father[i]=j表示点i的父亲是点j, father表示的树一定是一棵树而不是森林给定数组values，大小为N, values[们=v表示节点i的权值是v
 * 实现如下4个方法，保证4个方法都很快!
 ...
 */
public class code1_TreeChainPartition {
